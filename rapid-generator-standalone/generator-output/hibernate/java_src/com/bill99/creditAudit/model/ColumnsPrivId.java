...
@Embeddable
public class ColumnsPrivId extends BaseEntity implements java.io.Serializable{
	...
	@Column(name = "Table_name", unique = false, nullable = false, insertable = true, updatable = true, length = 64)	
	...
	@Column(name = "Column_name", unique = false, nullable = false, insertable = true, updatable = true, length = 64)	
