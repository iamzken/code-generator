...
@Repository
public class DbDao extends BaseHibernateDao<Db,java.lang.String>{
	...
	public Page findPage(DbQuery query) {
		...
		String sql = "select t from Db t where 1=1 "
        ...
        StringBuilder sql2 = new StringBuilder("select t from Db t where 1=1 ");
