...
<%@ include file="/commons/taglibs.jsp" %>
	...
	<tr>	
		<td class="tdLabel">
			<span class="required">*</span><%=Host.ALIAS_HOST%>:
		</td>		
		<td>
	...
	<tr>	
		<td class="tdLabel">
			<span class="required">*</span><%=Host.ALIAS_DB%>:
		</td>		
		<td>
	...
	<tr>	
		<td class="tdLabel">
			<span class="required">*</span><%=Host.ALIAS_SELECT_PRIV%>:
		</td>		
		<td>
	...
	<tr>	
		<td class="tdLabel">
			<span class="required">*</span><%=Host.ALIAS_INSERT_PRIV%>:
		</td>		
		<td>
	...
	<tr>	
		<td class="tdLabel">
			<span class="required">*</span><%=Host.ALIAS_UPDATE_PRIV%>:
		</td>		
		<td>
	...
	<tr>	
		<td class="tdLabel">
			<span class="required">*</span><%=Host.ALIAS_DELETE_PRIV%>:
		</td>		
		<td>
	...
	<tr>	
		<td class="tdLabel">
			<span class="required">*</span><%=Host.ALIAS_CREATE_PRIV%>:
		</td>		
		<td>
	...
	<tr>	
		<td class="tdLabel">
			<span class="required">*</span><%=Host.ALIAS_DROP_PRIV%>:
		</td>		
		<td>
	...
	<tr>	
		<td class="tdLabel">
			<span class="required">*</span><%=Host.ALIAS_GRANT_PRIV%>:
		</td>		
		<td>
	...
	<tr>	
		<td class="tdLabel">
			<span class="required">*</span><%=Host.ALIAS_REFERENCES_PRIV%>:
		</td>		
		<td>
	...
	<tr>	
		<td class="tdLabel">
			<span class="required">*</span><%=Host.ALIAS_INDEX_PRIV%>:
		</td>		
		<td>
	...
	<tr>	
		<td class="tdLabel">
			<span class="required">*</span><%=Host.ALIAS_ALTER_PRIV%>:
		</td>		
		<td>
	...
	<tr>	
		<td class="tdLabel">
			<span class="required">*</span><%=Host.ALIAS_CREATE_TMP_TABLE_PRIV%>:
		</td>		
		<td>
	...
	<tr>	
		<td class="tdLabel">
			<span class="required">*</span><%=Host.ALIAS_LOCK_TABLES_PRIV%>:
		</td>		
		<td>
