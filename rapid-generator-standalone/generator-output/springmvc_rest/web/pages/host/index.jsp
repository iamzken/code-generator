...
<rapid:override name="content">
	...
	<div class="queryPanel">
		...
		<div class="handleControl">
			<input type="submit" class="stdButton" style="width:80px" value="查询" onclick="getReferenceForm(this).action='${ctx}/host'"/>
			<input type="button" class="stdButton" style="width:80px" value="新增" onclick="window.location = '${ctx}/host/new'"/>
			<input type="button" class="stdButton" style="width:80px" value="删除" onclick="doRestBatchDelete('${ctx}/host','items',document.forms.queryForm)"/>
		<div>
		...
		<table width="100%"  border="0" cellspacing="0" class="gridBody">
		  ...
		  <tbody>
			  ...
			  <tr class="${status.count % 2 == 0 ? 'odd' : 'even'}">
				...
				<td>
					<a href="${ctx}/host/${item.host}">查看</a>&nbsp;&nbsp;
					<a href="${ctx}/host/${item.host}/edit">修改</a>&nbsp;&nbsp;
					<a href="${ctx}/host/${item.host}" onclick="doRestDelete(this,'你确认删除?');return false;">删除</a>
				</td>
			  </tr>
